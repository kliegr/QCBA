...
The model:
    ...
    {Petal.Width=[-Inf;0.6]} => {Species=setosa}	                          0.32    	1.00	
    {Petal.Length=[5.2;Inf]} => {Species=virginica}                       	0.25    	1.00	 
    {Sepal.Width=[-Inf;3.1],Petal.Width=[1.8;Inf]} => {Species=virginica}	  0.20	    1.00	
    {} => {Species=versicolor}                                             	0.36	    0.36
