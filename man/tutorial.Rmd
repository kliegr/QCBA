...
```{r}
rmqCBAatt0 <- qcba(cbaRuleModel=rmCBA,datadf=data_raw, extendType="numericOnly", postpruning = "none", defaultRuleOverlapPruning="noPruning", attributePruning=TRUE, createHistorySlot=FALSE,loglevel = "WARNING")

print(rmqCBAatt0@rules)
```
Rule list with attribute pruning:

```{r message=FALSE}
  rmqCBAatt <- qcba(cbaRuleModel=rmCBA,datadf=data_raw, extendType="noExtend",trim_literal_boundaries = TRUE, postpruning = "none", defaultRuleOverlapPruning="noPruning", attributePruning=TRUE, createHistorySlot=FALSE,loglevel = "WARNING")
 print(rmqCBAatt@rules)
```
...
```{r}
  rmqCBATEST <- qcba(cbaRuleModel=rmCBA,datadf=data_raw, extendType="numericOnly",trim_literal_boundaries = FALSE, postpruning = "cba", defaultRuleOverlapPruning="noPruning", createHistorySlot=FALSE,loglevel = "FINE")
 print(rmqCBATEST@rules)
```
