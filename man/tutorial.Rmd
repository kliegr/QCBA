...
```{r message=FALSE}
rmqCBAiris <- qcba(cbaRuleModel=rmCBAiris,datadf=trainFold, attributePruning = TRUE, extendType="numericOnly", postpruning="cba", defaultRuleOverlapPruning="noPruning")
print(rmqCBAiris@rules)
```
