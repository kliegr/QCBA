...
#  Part 1: how to build CBA and QCBA model
...
Let's look at the humtemp sample data bundled with the arc package, which we will be using throughout this tutorial There are two explanatory attributes (Temperature and Humidity). The target attribute is preference (e.g. subjective comfort level). 
...
#  Part 2: explaining optimization steps in QCBA
