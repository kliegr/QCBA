...
Let's look at sample data. There are two explanatory attributes (Temperature and Humidity). The target attribute is preference (e.g. subjective comfort level). 
...
```{r results='hide'}
rmqCBA <- qcba(cbaRuleModel=rmCBA,datadf=data_raw,extensionStrategy= "ConfImprovementAgainstLastConfirmedExtension", trimming = TRUE, continuousPruning = FALSE, postpruning = FALSE, minImprovement=0, minCondImprovement=-0.15, minConf = 0.5, createHistorySlot=TRUE,loglevel = "WARNING")
print(rmqCBA@rules)
```
...
#### Animation of QCBA Extension and Trimming (strategy ConfImprovementAgainstLastConfirmedExtension)
...
Note that QCBA improved confidene of rule 2 from 0.75 to 1.0 and support from 0.09 to 0.18.
#### Other QCBA features not demonstrated

```{r results='hide'}
rmqCBA <- qcba(cbaRuleModel=rmCBA,datadf=data_raw,extensionStrategy= "ConfImprovementAgainstSeedRule", trimming = TRUE, continuousPruning = FALSE, postpruning = FALSE, minImprovement=0, minCondImprovement=-0.15, minConf = 0.5, createHistorySlot=TRUE,loglevel = "WARNING")
print(rmqCBA@rules)
```
