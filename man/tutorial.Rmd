...
* To our knowledge, the tirst non-fuzzy "quantitative" association rule classification algorithm.
...
rmqCBAiris <- qcba(cbaRuleModel=rmCBAiris,datadf=trainFold,extendType="noExtend", postpruning="none", defaultRuleOverlapPruning="noPruning")
