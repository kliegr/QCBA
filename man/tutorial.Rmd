...
postpruning <- TRUE
rmqCBA <- qcba(cbaRuleModel=rmCBA,datadf=data_raw, trim_literal_boundaries = trim_literal_boundaries, postpruning = postpruning, createHistorySlot=TRUE,loglevel = "WARNING")
print(rmqCBA@rules)
...
#### QCBA model with removal of rules made redundant by the default rule  (default rule overlap)
...
```{r results='hide'}
trim_literal_boundaries = TRUE
rmqCBA_doR <- qcba(cbaRuleModel=rmCBA,datadf=data_raw,defaultRuleOverlapPruning="rangeBased",extensionStrategy= "ConfImprovementAgainstLastConfirmedExtension", trim_literal_boundaries = trim_literal_boundaries, continuousPruning = FALSE, postpruning = TRUE, minImprovement=0, minCondImprovement=-1, minConf = 0.5, createHistorySlot=TRUE,loglevel = "WARNING")
...
```{r results='hide'}
trim_literal_boundaries = TRUE
rmqCBA_doT <- qcba(cbaRuleModel=rmCBA,datadf=data_raw,defaultRuleOverlapPruning="transactionBased",extensionStrategy= "ConfImprovementAgainstLastConfirmedExtension", trim_literal_boundaries = trim_literal_boundaries, continuousPruning = FALSE, postpruning = TRUE, minImprovement=0, minCondImprovement=-1, minConf = 0.5, createHistorySlot=TRUE,loglevel = "WARNING")
